  ...
  if (isFinished) {
    const typeTheme: Record<string, {
      ...
      weekly: {
        ...
        bg:          'linear-gradient(160deg, #1e0800 0%, #120400 60%, #07000C 100%)',
        border:      '#3a1400',
        borderHover: '#7a3000',
    ...
    const theme = typeTheme[tournament.type] ?? {
      accent: '#C4001C', accentDim: 'rgba(200,0,0,0.15)', glow: 'rgba(200,0,0,0.2)',
      bg: 'linear-gradient(160deg, #15000E 0%, #120000 100%)',
      border: '#260015', borderHover: '#660000',
      btnBg: 'linear-gradient(135deg, #C4001C, #880000)', btnColor: '#fff',
      medal: '🏅',
    }
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-stretch">
          ...
          <div className="flex-1 p-7 pr-4">
            ...
            <div className="flex flex-wrap gap-2 mb-5">
              ...
              <span
                className="text-[10px] font-black px-3 py-1 rounded-full tracking-widest uppercase"
                style={{ background: 'rgba(255,180,0,0.15)', color: '#FFC500', border: '1px solid rgba(255,180,0,0.3)' }}
              >
                {typeLabels[tournament.type]}
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-6 mb-6">
              ...
              <div>
                ...
                <p className="font-black text-2xl" style={{ color: '#FFC500', textShadow: '0 0 24px rgba(255,215,0,0.5)' }}>
                  €{tournament.prizePool.toLocaleString('pl-PL')}
                </p>
              </div>
              {/* Divider */}
            ...
            <div className="flex gap-3">
              <a
                ...
                style={{ background: 'linear-gradient(135deg, #FFC500 0%, #FFA500 100%)', boxShadow: '0 4px 16px rgba(255,180,0,0.3)' }}
              >
                Czytaj więcej
              </a>
              <button
          ...
          >
            {/* Ambient glow blob — replaces the hard left fade */}
            <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 85% 80% at 55% 50%, rgba(120,0,255,0.12) 0%, rgba(255,180,0,0.05) 50%, transparent 80%)' }} />

            {/* Decorative rings */}
            <div className="relative flex items-center justify-center">
              {/* Outer glow ring */}
              <div className="absolute rounded-full" style={{ width: '200px', height: '200px', background: 'radial-gradient(circle, rgba(140,0,255,0.12) 0%, rgba(255,180,0,0.05) 45%, transparent 70%)' }} />
              {/* Ring 1 */}
              <div className="absolute rounded-full" style={{ width: '168px', height: '168px', border: '1px solid rgba(160,60,255,0.18)', boxShadow: '0 0 24px rgba(140,0,255,0.1)' }} />
              {/* Ring 2 */}
              <div className="absolute rounded-full" style={{ width: '118px', height: '118px', border: '1px solid rgba(255,180,0,0.13)' }} />
              {/* Ring 3 inner */}
              <div className="absolute rounded-full" style={{ width: '76px', height: '76px', background: 'radial-gradient(circle, rgba(255,180,0,0.09) 0%, transparent 70%)', border: '1px solid rgba(255,200,50,0.16)' }} />
              ...
              {[
                ...
                { bottom: '28px', right: '54px' },
              ].map((pos, i) => (
                <div key={i} className="absolute" style={{ ...pos, width: '4px', height: '4px', borderRadius: '50%', background: '#FFC500', boxShadow: '0 0 6px rgba(255,215,0,0.8)', opacity: 0.6 }} />
              ))}
              ...
              <span
                ...
                style={{
                  fontSize: '76px',
                  lineHeight: 1,
                  filter: 'drop-shadow(0 0 28px rgba(255,180,0,0.6)) drop-shadow(0 0 10px rgba(200,80,255,0.45))',
                }}
              >
                🏆
              </span>
              ...
              {/* Floor glow */}
              <div className="absolute" style={{ bottom: '-2px', left: '50%', transform: 'translateX(-50%)', width: '72px', height: '10px', borderRadius: '50%', background: 'radial-gradient(ellipse, rgba(255,180,0,0.3) 0%, transparent 70%)', filter: 'blur(4px)' }} />
            </div>
          </div>
        </div>
    ...
    >
      ...
      <div className="relative z-10 p-6">
        ...
        <div className="flex items-center gap-2 mb-3">
          <span className="flex items-center gap-1.5 text-white text-xs font-bold px-2.5 py-1 rounded-full" style={{ background: '#C4001C' }}>
        ...
        <div className="flex gap-2 mb-5">
          <Link href="/go/" className="text-black font-bold text-sm px-6 py-2 rounded-lg hover:bg-yellow-400 transition" style={{ background: '#FFC500' }}>
            Weź udział
          </Link>
          ...
          <div className="mt-4">
            ...
            <div className="relative">
              ...
              <div
                ...
                style={{ background: 'linear-gradient(to right, transparent, #130010)' }}
              />
              {/* Fade left */}
              {scrolled && (
                <div
                  className="absolute left-0 top-0 h-full w-10 pointer-events-none"
                  style={{ background: 'linear-gradient(to left, transparent, #130010)' }}
                />
              )}
            </div>
          </div>
