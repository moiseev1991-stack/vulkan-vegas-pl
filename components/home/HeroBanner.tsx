...
const slides = [
  {
    ...
    cta: 'Zagraj teraz',
    ctaHref: '/go/',
    bg: 'linear-gradient(135deg, #260015 0%, #130012 50%, #07000C 100%)',
    image: '/images/hero/banner-easter-vv.png',
    badge: '🐰 WIELKANOC',
  },
  {
    id: 2,
    ...
    cta: 'Odbierz bonus',
    ctaHref: '/go/',
    bg: 'linear-gradient(135deg, #130010 0%, #2E001A 40%, #07000C 100%)',
    image: '/images/hero/banner-friday-vv.png',
    badge: '🎰 PIĄTEK',
  },
  {
    id: 3,
    ...
    cta: 'Weź udział',
    ctaHref: '/go/',
    bg: 'linear-gradient(135deg, #07000C 0%, #1a0800 40%, #0d0200 100%)',
    image: '/images/hero/banner-tournament-vv.png',
    badge: '🏆 TURNIEJE',
  },
  {
    id: 4,
    ...
    cta: 'Dołącz do VIP',
    ctaHref: '/go/',
    bg: 'linear-gradient(135deg, #07000C 0%, #0d0010 40%, #050008 100%)',
    image: '/images/hero/banner-vip-vv.png',
    badge: '💎 VIP',
  },
  {
    id: 5,
    ...
    image: '/images/hero/banner-live-vv.png',
    badge: '🎲 NA ŻYWO',
  },
  {
    id: 6,
    ...
    image: '/images/hero/banner-freespins-vv.png',
    badge: '⚡ FREE SPINS',
  },
]
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <button
            ...
            style={{ background: 'rgba(0,0,0,0.5)', border: '1px solid #2E001A', color: '#888' }}
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLButtonElement).style.background = 'rgba(100,0,80,0.4)'
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-20 hidden md:flex gap-2">
            {slides.map((_, i) => (
              <button
                ...
                style={i === current
                  ? { width: '10px', height: '10px', background: '#FFC500', boxShadow: '0 0 0 2px rgba(255,197,0,0.3)' }
        ...
        <div className="flex md:hidden justify-center gap-2 pt-2 pb-1">
          {slides.map((_, i) => (
            <button
              ...
              className="rounded-full transition-all duration-300"
              style={i === current
                ? { width: '24px', height: '8px', background: '#FFC500' }
                : { width: '8px', height: '8px', background: '#4b4b4b' }
              }
            />
          ))}
