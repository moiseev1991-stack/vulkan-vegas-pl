      ...
      <div className="absolute inset-0 overflow-hidden" style={{ opacity: 0.05 }}>
        {[...Array(8)].map((_, i) => (
          <div
            ...
            style={{
              top: `${10 + i * 12}%`,
              background: 'linear-gradient(to right, transparent, #FFC500, transparent)',
        ...
        >
          <div style={{ position: 'relative', width: s.size, height: s.size }}>
            <div style={{
              ...
              height: 1, background: '#FFC500',
              transform: 'translateY(-50%)',
            }} />
            <div style={{
              position: 'absolute', left: '50%', top: 0, bottom: 0,
              width: 1, background: '#FFC500',
      ...
      <div className="relative z-10 px-4">
        ...
        <h2
          ...
          style={{
            ...
            lineHeight: 1,
            background: 'linear-gradient(180deg, #FFC500 0%, #CC8800 50%, #FFC500 100%)',
