...
const inputClass =
  'w-full bg-[#0f0000] border border-[#3a0020] rounded-lg px-4 py-3 text-sm text-white placeholder-gray-700 focus:outline-none focus:border-[#C4001C] focus:ring-1 focus:ring-[#C4001C]/30 transition'
  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-4">
        ...
        {/* Registration CTA — moved up, right after hero */}
        <section id="register" className="py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(160deg, #130010 0%, #100000 100%)',
            ...
            >
                  ...
                  <button
                    ...
                    style={
                      formTab === val
                        ...
                        : { background: '#130010', border: '1px solid #2a0000', color: '#555' }
                    }
                  >
                    {label}
                  </button>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-2">
                  <div
                    ...
                    style={{
                      ...
                      background: checked ? '#C4001C' : 'transparent',
                    }}
                  ...
                  <p className="text-xs text-gray-600">
                    ...
                    <Link href="/regulamin" className="hover:underline" style={{ color: '#C4001C' }}>Regulamin</Link>
                    {' '}oraz{' '}
                    <Link href="/polityka-prywatnosci" className="hover:underline" style={{ color: '#C4001C' }}>
                ...
                <button
                  ...
                  style={{
                    background: 'linear-gradient(120deg, #FFC500, #CC8800)',
            ...
            >
                ...
                {([['casino', 'BONUS KASYNOWY'], ['sports', 'BONUS SPORTOWY']] as const).map(([val, label]) => (
                  <button
                    ...
                    style={
                      bonusTab === val
                        ? {
                            background: 'linear-gradient(135deg, #FFC500, #CC8800)',
                            color: '#000',
                            fontWeight: 700,
              ...
              {bonusTab === 'casino' ? (
                <div>
                  <p className="font-black text-2xl mb-1" style={{ color: '#FFC500' }}>DO 2 500 €</p>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <div
                        ...
                        style={{ background: '#0f0000', border: '1px solid #160010' }}
                      >
                ...
                <div>
                  <p className="font-black text-2xl mb-1" style={{ color: '#FFC500' }}>DO 1 000 €</p>
              ...
              <div className="mt-6 flex items-center justify-center gap-2 text-xs text-gray-700">
                <span
                  ...
                  style={{ background: 'rgba(255,215,0,0.1)', color: '#FFC500' }}
                >
                  Załóż konto
                </span>
                <span>→</span>
      ...
      <section className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside text-gray-500 text-sm space-y-1 mb-3">
            ...
            <li>Aktywne konto w kasynie Vulkan Vegas z pozytywną historią wypłat i brakiem naruszeń regulaminu</li>
          ...
          <p className="text-gray-500 text-sm leading-relaxed mb-3">Struktura programu lojalnościowego w Vulkan Vegas opiera się na pięciostopniowej hierarchii poziomów VIP, z których każdy reprezentuje odrębny ekosystem benefitów, wymagań oraz przywilejów. System został zaprojektowany z myślą o progresywnym nagradzaniu lojalności i aktywności graczy, gdzie każdy kolejny szczebel stanowi znaczący skok jakościowy w zakresie otrzymywanych korzyści materialnych oraz niematerialnych. Kluczową filozofią tego modelu jest transparentność i przewidywalność – każdy gracz wie dokładnie, ile punktów lojalnościowych musi zgromadzić, aby awansować, oraz jakie konkretne benefity go czekają po przekroczeniu progu. W przeciwieństwie do systemów opartych na subiektywnych zaproszeniach, model Vulkan Vegas eliminuje element arbitralności, tworząc merytoktratyczny mechanizm awansu dostępny dla wszystkich aktywnych użytkowników platformy.</p>
          ...
          <div className="overflow-x-auto mb-3">
            <table className="w-full text-xs text-gray-500 border-collapse">
              ...
              <tbody>
                <tr>
                  <td className="border border-gray-700 px-2 py-1">Rejestracja konta w Vulkan Vegas</td>
          ...
          <h3 className="text-lg font-black text-white mb-2">Ile czasu trwa wypłata dla gracza Diamentowego w Vulkan Vegas?</h3>
