...
const SEGMENTS = [
  { label: 'EU€5',      color: '#6B0010' },
  { label: 'EU€15',     color: '#A8001A' },
  { label: 'FS 50',     color: '#6B0010' },
  { label: 'FS 7',      color: '#A8001A' },
  { label: '120% BONUS', color: '#6B0010' },
  { label: 'Respin',    color: '#A8001A' },
  { label: 'Puste',     color: '#500010' },
  { label: 'EU€3',      color: '#A8001A' },
]
...
export default function WheelClient() {
  ...
  const draw = useCallback((rot: number) => {
    ...
    for (let i = 0; i < 32; i++) {
      ...
      ctx.fillStyle = i % 2 === 0 ? '#FFC500' : '#FFD700'
  ...
  return (
    <div
      ...
      style={{ background: 'radial-gradient(ellipse 80% 70% at 50% 40%, #2a0008 0%, #110002 50%, #050008 100%)' }}
    >
      {/* Laser beams */}
      <svg
      ...
      >
        <defs>
          <linearGradient id="lg1" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#C4001C" stopOpacity="0.5" />
            <stop offset="100%" stopColor="#C4001C" stopOpacity="0" />
          </linearGradient>
        ...
        <button
          ...
          style={{
            background: spinning || spinsLeft <= 0
              ? '#333'
              : 'linear-gradient(135deg, #FFC500, #FFB500)',
          ...
          <div className="flex gap-3 justify-center">
            {MULTIPLIERS.map((m) => (
              <button
                ...
                style={
                  multiplier === m
                    ? { background: '#FFC500', color: '#111', boxShadow: '0 0 12px rgba(255,215,0,0.5)' }
                    : { background: '#130010', color: 'rgba(255,255,255,0.45)', border: '1px solid #2E001A' }
                }
              >
                X{m}
              </button>
      ...
      {modal && (
        ...
        >
          <div
            ...
            style={{
              background:  'linear-gradient(135deg, #130010, #260015)',
          ...
          >
            ...
            {modal.label !== 'Puste' && (
              <div className="text-3xl font-black mb-1" style={{ color: '#FFC500' }}>
                {modal.label}
              </div>
            )}
            ...
            <button
              ...
              style={{ background: '#FFC500', color: '#111' }}
            >
